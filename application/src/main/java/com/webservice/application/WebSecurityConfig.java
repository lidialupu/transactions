...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/transactions").hasAuthority("ROLE_ADMIN")
                .antMatchers("/transactions/delete{id}").hasAuthority("ROLE_ADMIN")
                .antMatchers("/transactions/update{id}").hasAnyAuthority("ROLE_ADMIN", "ROLE_MODERATOR")
